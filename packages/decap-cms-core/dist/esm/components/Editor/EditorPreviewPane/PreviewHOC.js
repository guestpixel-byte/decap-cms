...
const _excluded = ["previewComponent", "className"];
...
class PreviewHOC extends _react.default.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(previewComponent, _objectSpread({
      className
    }, props));
  }
}
PreviewHOC.propTypes = {
  ...
  fieldsMetaData: _propTypes.default.object
};
